...
public class TRAII_22s_t21_22_testi
{
    ...
    public static void main(String[] args) {
        ...
        TRAII_22s_t21_22    tiedostoJoukko;
        ...
        if (args.length < 2) {
            ...
            tiedostoJoukko = new TRAII_22s_t21_22("data2122.data", maxKoko);
            ...
            if (args.length > 2) {
                ...
                // uusi tiedosto
                tiedostoJoukko = new TRAII_22s_t21_22(args[0], maxs);

            } else {

                // vanha tiedosto
                tiedostoJoukko = new TRAII_22s_t21_22(args[0]);
                vanha = true;
